...
\begin{frame}[label={sec:org7561747}]{CHIRP + Radiance Based L3 Retrieval Data Flow}
\begin{center}
...
\begin{frame}[label={sec:org9104baa}]{CHIRP only Data Flow: Useful for Level 2 Retrievals?}
\vspace{-0.1in}
...
\begin{frame}[label={sec:orgf5fcd1a}]{AIRS2CrIS Algorithm}
\vspace{-0.15in}
\begin{small}
\begin{itemize}
...
\begin{frame}[label={sec:orgde47351}]{Time Series Tests}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org23b5a34}]{Pros of CHIRP}
\begin{itemize}

...
\begin{center}
\includegraphics[width=0.7\linewidth]{./sFigs/PDF/sno_march2018_snpp_minus_noaa20_with_c2_airs_ingrey.pdf}
\end{center}
...
\vspace{-0.1in}
\begin{center}
\includegraphics[width=0.64\linewidth]{./airs2cris_vx_sounding.pdf}
\end{center}
\end{frame}
...
\vspace{-0.15in}
\begin{center}
\includegraphics[width=0.8\linewidth]{./Figs/Pdf/airs_14year_global_trends.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=\linewidth]{./pFigs/final_l3_t.png}
\end{center}
\end{block}
\end{column}
...
\begin{center}
\includegraphics[width=\linewidth]{./pFigs/final_umbc_t_zoom_cmap.png}
\end{center}
\end{block}
\end{column}
\end{columns}
...
\vspace{-0.1in}
\begin{center}
\includegraphics[width=0.8\linewidth]{./calFigs/Png/water_lati_30_UMBC.png}
\end{center}
\end{block}
\end{column}
...
\vspace{-0.1in}
\begin{center}
\includegraphics[width=0.8\linewidth]{./calFigs/Png/water_lati_30_ERA.png}
\end{center}
\end{block}
\end{column}
\end{columns}
...
\vspace{-0.1in}
\begin{center}
\includegraphics[width=0.8\linewidth]{./calFigs/Png/water_lati_30_L3.png}
\end{center}
\end{block}
\end{column}
\end{columns}

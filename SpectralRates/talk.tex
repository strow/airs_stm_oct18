...
\begin{frame}[label={sec:orgff37119}]{Time Series Length Nearing Climate Scales}
\vspace{-0.3in}
...
\begin{frame}[label={sec:orgf2dec75}]{CHIRB Processing Flow}
\vspace{-0.2in}
\begin{center}
...
\begin{frame}[label={sec:orgc6789a2}]{Time/Space Gridded Radiance Data Flow}
\vspace{-0.1in}
\begin{center}
...
\begin{frame}[label={sec:org44ea2cc}]{Data Used for Preliminary Results}
\begin{itemize}
...
\begin{frame}[label={sec:orgd216993}]{Global B(T) Trend (Area Weighted)}
\vspace{-0.15in}
\begin{center}
...
\begin{frame}[label={sec:org1e40e25}]{Retrieved Zonal Trends (T/\water/T\(_{\text{surf}}\))}
\vspace{-0.35in}
...
\begin{frame}[label={sec:orgc946e76}]{Stratopsheric Ozone Trend Inter-Comparisons}
\vspace{-0.15in}
...
\begin{frame}[shrink=10,label={sec:org4bf4195}]{Trend Uncertainties: Only Diagonal Meas. Error Covariance}
\vspace{-0.1in}
\small

...
%  \end{center}
  ...
  \begin{center}
    \dlandgraph{0.5}{Figs/umbc_total_vs_atm_vs_GHG.png}{Figs/umbc_total_vs_atm_vs_GHG2.png}
  \end{center}
...
%  \end{center}
  ...
  \begin{center}
    \dlandgraph{0.5}{Figs/umbc_wvonly_spectralfluxchange.png}{Figs/umbc_co2only_spectralfluxchange.png}
  \end{center}
...
%  \end{center}
  ...
  \begin{center}
    \dlandgraph{0.5}{Figs/umbc_STonly_spectralfluxchange.png}{Figs/umbc_Tonly_spectralfluxchange.png}
  \end{center}
